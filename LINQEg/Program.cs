...
namespace LINQEg
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                new Student(1001,"Janaka","Trichy","female",19),
                new Student(1002,"ravi","chennai","male",20),
                new Student(1003,"balu","Madurai","male",21),
                new Student(1004,"ABI","Salem","female",17)
            };
            ...
            //Display the name and age age of the student 
